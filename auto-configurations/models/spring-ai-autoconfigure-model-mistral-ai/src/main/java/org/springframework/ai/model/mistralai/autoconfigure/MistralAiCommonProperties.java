...
public class MistralAiCommonProperties extends MistralAiParentProperties {
	...
	@Override
	public String getApiKeyOrDefault(MistralAiCommonProperties commonProperties) {
		throw new UnsupportedOperationException(DEFAULTING_EXCEPTION_MESSAGE);
	}

	@Override
	public String getBaseUrlOrDefault(MistralAiCommonProperties commonProperties) {
		throw new UnsupportedOperationException(DEFAULTING_EXCEPTION_MESSAGE);
	}
